$(document).ready(function() {
	var overlaymatcostpre = document.querySelector( 'div.overlay-matcostpre' ),
		...
		closematcostpre = document.querySelector( 'div.overlay-close-matcostpre'),
		closewarehousingpre = document.querySelector( 'div.overlay-close-warehousingpre'),
		closetransportationcu = document.querySelector( 'div.overlay-close-transportationcu'),
		closelabourcu = document.querySelector( 'div.overlay-close-labourcu'),
		closetimecu = document.querySelector( 'div.overlay-close-timecu'),
		closetransportationpost = document.querySelector( 'div.overlay-close-transportationpost'),
		closedisposalpost = document.querySelector( 'div.overlay-close-disposalpost'),
		transEndEventNames = {
